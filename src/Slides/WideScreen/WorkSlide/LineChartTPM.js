...
const LineChartTPM = () => {
  ...
  useEffect(() => {
    ...
    const y = d3
      .scaleLinear()
      .domain([0, d3.max(data, d => d.TPM) + 2])
      .range([height, 0]);
    ...
    svg
      .append('g')
      .selectAll('line')
      .data(d3.range(2, d3.max(data, d => d.TPM) + 2, 2))
      .enter()
      .append('line')
    ...
    svg
      ...
      .duration(500)
      .attr('opacity', 1)
      .text('Evolución de la Tasa de Política Monetaria (TPM) en Chile (2012-2022)');
 // Leyenda
 const legendData = [
    { color: '#CB6D51', label: 'TPM' },
