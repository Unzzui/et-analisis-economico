...
const LineCharTPM = () => {
  ...
  useEffect(() => {
    ...
    const data = [
      { Periodo: 2012, Desocupación: 7 },
      { Periodo: 2013, Desocupación: 6 },
      { Periodo: 2014, Desocupación: 6 },
      { Periodo: 2015, Desocupación: 6 },
      { Periodo: 2016, Desocupación: 7 },
      { Periodo: 2017, Desocupación: 7 },
      { Periodo: 2018, Desocupación: 7 },
      { Periodo: 2019, Desocupación: 7 },
      { Periodo: 2020, Desocupación: 11 },
      { Periodo: 2021, Desocupación: 9 },
      { Periodo: 2022, Desocupación: 8 },
    ];
    ...
    const y = d3
      .scaleLinear()
      .domain([0, d3.max(data, d => d.Desocupación) + 2])
      .range([height, 0]);
    ...
    svg
      .append('g')
      .selectAll('line')
      .data(d3.range(2, d3.max(data, d => d.Desocupación) + 2, 2))
      .enter()
      .append('line')
    ...
    svg
      ...
      .attr('y', d => y(d.Desocupación) - 10)
      .text(d => `${d.Desocupación}%`)
    ...
    svg
      ...
      .duration(500)
      .attr('opacity', 1)
      .text('Evolución de la Desocupación en Chile (2012-2022)');
 // Leyenda
 const legendData = [
    { color: '#CB6D51', label: 'Desocupación' },
